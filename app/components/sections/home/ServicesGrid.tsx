...
export default function ServicesGrid({ locale, dict }: ServicesGridProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (floatingImgRef.current) {
        floatingImgRef.current.style.transform =
          `translate3d(${imgPos.current.x - 140}px, ${imgPos.current.y - 190}px, 0)`;
      }
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      rows.forEach((row) => {
        ...
        if (number) {
          tl.to(number, { opacity: 1, x: 0, duration: 0.8, ease: 'power3.out' }, 0);
        }
        ...
        // Kicker fades up
        if (kicker) {
          tl.to(kicker, { opacity: 1, y: 0, duration: 0.7, ease: 'power3.out' }, 0.1);
        }

        // Title slides up (the main event)
        if (title) {
          tl.to(title, { opacity: 1, y: 0, duration: 1.0, ease: 'power3.out' }, 0.15);
        }

        // Description fades up
        if (desc) {
          tl.to(desc, { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' }, 0.25);
        }

        // Arrow slides in
        if (arrow) {
          tl.to(arrow, { opacity: 1, x: 0, duration: 0.6, ease: 'power3.out' }, 0.3);
        }
      });
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const mobileCards = sectionRef.current?.querySelectorAll('[data-mobile-card]');
  ...
  return (
    <section ref={sectionRef} className="relative" style={{ backgroundColor: '#FAF7F2' }}>
      ...
      {isMobile === null ? (
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-8 lg:px-16 pt-8 pb-20" style={{ minHeight: '60vh' }} />
      ) : isMobile === false ? (
        <>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        fontSize: '42px',
                        fontWeight: 300,
                        color: hoveredSlug === procedure.slug ? '#B8860B' : 'rgba(61,56,48,0.15)',
                        lineHeight: 1,
                    ...
                    <div>
                      <h3
                        ...
                        style={{
                          ...
                          fontWeight: 300,
                          color: hoveredSlug === procedure.slug ? '#3D3830' : 'rgba(61,56,48,0.7)',
                          lineHeight: 1.15,
                    ...
                    <div
                      ...
                      style={{
                        ...
                        transform: hoveredSlug === procedure.slug ? 'translateX(0)' : 'translateX(-8px)',
                  ...
                  <div
                    ...
                    style={{
                      height: '1px',
                      background: hoveredSlug === procedure.slug
              ...
              >
                ...
                >
                  ...
                  <svg width="16" height="6" viewBox="0 0 16 6" fill="none">
                    <line x1="0" y1="3" x2="10" y2="3" stroke="#B8860B" strokeWidth="0.75" />
                    <path
