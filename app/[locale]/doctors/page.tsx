...
import { DoctorGrid } from '@/app/components/sections/doctors/DoctorGrid';
...
export async function generateMetadata({ params }: DoctorsPageProps): Promise<Metadata> {
  ...
  return generatePageMetadata(locale, 'doctors', '/doctors');
}
      ...
      <div className="min-h-screen py-20 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection animation="fadeUp" delay={0.2}>
            <DoctorGrid className="max-w-7xl mx-auto" />
          </AnimatedSection>
        </div>
      </div>
    </GsapProvider>
